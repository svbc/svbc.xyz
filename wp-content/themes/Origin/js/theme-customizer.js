...
( function( $ ) {
	...
	wp.customize( 'et_origin[sidebar_text_color]', function( value ) {
		value.bind( function( to ) {
			$( '#sidebar, #sidebar h4' ).css( 'color', to );
		} );
	} );

	wp.customize( 'et_origin[sidebar_links_color]', function( value ) {
		value.bind( function( to ) {
			$( '#sidebar a, #top-menu li a' ).css( 'color', to );
		} );
	} );
