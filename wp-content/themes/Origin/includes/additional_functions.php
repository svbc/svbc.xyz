...
?>
	<div id="et_custom_settings" style="margin: 13px 0 17px 4px;">
		<p style="margin-bottom: 22px;">
			...
			<input class="upload_image_button" type="button" value="<?php esc_attr_e( 'Upload Image', 'Origin' ); ?>" data-choose="<?php esc_attr_e( 'Choose Big Thumbnail', 'Origin' ); ?>" data-update="<?php esc_attr_e( 'Use For Big Thumbnail', 'Origin' ); ?>" /><br/>
